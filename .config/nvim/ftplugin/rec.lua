...
Helper.map(Helper.Type.MANUAL, "https://www.gnu.org/software/recutils/manual/")
Helper.map(Helper.Type.API, "https://www.gnu.org/software/recutils/manual/Concept-Index.html#Concept-Index")
